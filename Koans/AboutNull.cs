...
namespace DotNetCoreKoans.Koans
{
    public class AboutNull : Koan
    {
        ...
        public void YouGetNullPointerErrorsWhenCallingMethodsOnNull()
        {
            ...
            {
                Assert.Contains("Object reference not set to an instance of an object" as string, ex.Message); //NOTE: using ex.Message here works too - why???
            }
        }
        ...
        {
            object obj = null;
            Assert.True(obj is null); //NOTE: STILL Need to understand this better!!!!
        }
    }
}