...
namespace DotNetCoreKoans.Koans
{
    public class AboutDecimals : Koan
    {
        ...
        public void DecimalsAndOtherFloatingPointTypesDoNotPlayNice()
        {
            ...
            Assert.Equal(9.3m, result);  //MY NOTES: For the ex: you have to actually change the value in the result variable above!

            //result = d + (FillMeIn) db;

            Assert.Equal(9.3m, result);  //MY NOTES: for the ex: you have to change the value in the expected value in the Assert here!
        }
